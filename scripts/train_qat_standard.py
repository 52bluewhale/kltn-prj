...
print(model_yolo.info())  # Xác nhận YOLOv8n
...
def main():
    global model_yolo  # Khai báo biến toàn cục
    # Huấn luyện QAT
    finetune_epochs = 5
    try:
        ...
        model_yolo.train(data=dataset_path,
                         ...
                         batch=4,  # Giảm để tránh VRAM đầy
                         imgsz=640,
                         dropout=0.1,
                         device=0,
                         lr0=0.0005,
                         ...
                         amp=True,
                         mosaic=0.0,
                         hsv_h=0.0, fliplr=0.0, translate=0.0,
                         workers=2,  # Giảm để ổn định
                         verbose=True)
    ...
    # Lưu mô hình QAT
    try:
        qat_model_path = "F:/kltn-prj/models/checkpoints/qat_standard/best_qat.pt"
    ...
    try:
        ...
        int8_model_path = "F:/kltn-prj/models/checkpoints/qat_standard/best_qat.pt"
